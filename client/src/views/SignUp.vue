<template>
  <div class="login">
    ...
    <div class="signup_box">
      ...
      <input type="password" placeholder="PASSWORD" value="" id="user_pw"><br>
      <label for="user_pw_confirm">CONFIRM PASSWORD</label>
      <input type="password" placeholder="CONFIRM PASSWORD" value="" id="user_pw_confirm"><br>
      <label for="user_first_name">FIRST NAME</label>
      <input type="text" placeholder="FIRST NAME" value="" id="user_first_name"><br>
      <label for="user_last_name">LAST NAME</label>
      <input type="text" placeholder="LAST NAME" value="" id="user_last_name">
    </div>
    <button @click="clickCreate">OK</button>
  ...
  export default {
    ...
    methods: {
      async clickCreate() {
        ...
        const signup = await this.$http.post(
          `${process.env.VUE_APP_API_HOST_URL}/api/v1/auth/join`,
          paramObj,
          {
            headers: {
        ...
        if(signup && signup.data.result === 200) {
          this.$router.push('/');
        } else {
